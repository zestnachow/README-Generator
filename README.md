...
# Description
With this application, users can generate comprehensive README files based on their command-line inputs.
# Table of Contents
...
* [Questions](#questions)
# Installation
To run this application, the following dependencies/packages must be installed: Inquirer (after opening an integrated terminal and running a standard npm i, run npm i inquirer@8.2.4).
# Usage
